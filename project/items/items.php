    ...
    <div class="max-w-72 flex flex-col gap-3 text-sm justify-between">
        <div class="w-full relative flex">
            ...
            <div class="w-full flex justify-between text-center text-2xl text-primary absolute top-0 p-3">
                <div class="h-11 aspect-square grid place-content-center p-1.5 rounded-full bg-secondary text-sm uppercase font-light">
                    <span><?echo $items[2];?></span>
                </div>
                <div class="btn btn-circle btn-primary hover:bg-primary h-11 aspect-square grid place-content-center p-2.5 group">
        ...
        <div class="flex gap-2 text-base">
            ...
            <? } else { ?>
                <span><?echo number_format($items[4], 0, '.', '.')?> Тг.
            <? } ?>
        </div>
